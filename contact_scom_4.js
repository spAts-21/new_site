...
var excel_file_API = './Scom_Contacts.xlsx';
...
$(document).ready(function(){
    ...
    fetch('./Scom_Contacts.xlsx').then(function (res) {
        ...
        ********************************************************************/
        ...
        /************************ End of conversion ************************/
		 ...
		 $.each(jsondata, function (index, value) {
			...
			'<h5>' + value["Department"] + '</h5>' + '<br/>' + '<div class="social-strip">' + '<a href="mailto:' + value["Email id"] + '"> <img src="https://drive.google.com/uc?id='+Idm+'"; alt="mail"; height="18px"> </a>' + '&nbsp' + '&nbsp' + '&nbsp'
